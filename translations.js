const translations = {
    en: {
        ...
        litdNote: "<strong>Folded Galaxies</strong><br><br>The songs on this album originated as demos recorded in the late 1990s with the band Light in the Darkness.<br><br>In 2025, I revisited these recordings, rebuilt them from the ground up, and completed them with new lyrics and vocals.<br><br>Bringing them back felt like opening an old jacket and finding a galaxy hidden in the fold.<br><br>Deep thanks to Víťa and Michal, who co-created the original demos and kindly agreed to their reuse and transformation into this album.",
    ...
    cs: {
        ...
        litdEvent2: "Golf club",
        litdNote: "<strong>Folded Galaxies</strong><br><br>Skladby na tomto albu vznikly jako dema nahraná koncem 90. let s kapelou Světlo ve tmě.<br><br>V roce 2025 jsem se k těmto nahrávkám vrátil, přestavěl je od základů a dokončil s novými texty a vokály.<br><br>Jejich oživení bylo jako otevřít starou bundu a najít v záhybu ukrytou galaxii.<br><br>Velké díky Víťovi a Michalovi, kteří se podíleli na původních demech a laskavě souhlasili s jejich použitím a přeměnou v toto album.",
