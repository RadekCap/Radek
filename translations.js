const translations = {
    en: {
        ...
        soloDesc3: "The result: <a href=\"#rock-majesty\"><strong>Rock Majesty</strong></a> and <a href=\"#one-beautiful-day\"><strong>One Beautiful Day in Litomyšl</strong></a> — the first original compositions, marking the beginning of a new chapter.",

        // Timeline - Recorded Extreme II For Myself
        extremeDate: "2026",
        extremeTitle: "Recorded Extreme II For Myself",
        ...
        backyardDesc: "They reached out and invited me to join. I listened to their repertoire and recordings — and at first decided to stay the course, continuing to study and play on my own. But somewhere along the way, a thought crept in: <em>\"Hey, just try it — it could be fun.\"</em> So I gave it a shot. What I found was a great group of people and a shared love of music. And with them came something I hadn't felt in a long time — that spine-tingling chill when a song lands exactly right, and a fresh energy running through my veins.",
    ...
    cs: {
        ...
        soloDesc3: "Výsledek: <a href=\"#rock-majesty\"><strong>Rock Majesty</strong></a> a <a href=\"#one-beautiful-day\"><strong>One Beautiful Day in Litomyšl</strong></a> — první originální skladby, které znamenají začátek nové kapitoly.",

        // Timeline - Recorded Extreme II For Myself
        extremeDate: "2026",
        extremeTitle: "Nahrál jsem si Extreme II",
